...
#https://github.com/Inderby/SystemProgramming/blob/main/template.py
...
def load_dataset(dataset_path):
    ...
    csv_test = pd.read_csv(dataset_path, encoding='utf-8')
    return csv_test
...
def split_dataset(dataset_df, testset_size):
	#To-Do: Implement this function
    X_train, X_test, y_train, y_test = train_test_split(dataset_df.iloc[:,:-1], dataset_df.loc[:,'target'],test_size = testset_size)
